              ...
              <div id="fire-ball">
                <div id="fire-ball-overlay">
                  ...
                  <p className="plus-jakarta about-text mt-5 pb-10">
                    ...
                    coaches worldwide to upload their data,The aim is to provide
                    a platform that will serve as a go-to for clubs and agents
                    to access players and coaches they are interested in all
                    around the globe with specific player evaluation and
                    detailed profiling.
                  </p>
                </div>
              </div>
